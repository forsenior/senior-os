...
from src.phish.update_phishing_txt import PhishingDatabaseModificationChecker
...
class MyBrowser(QMainWindow):
    ...
    def __init__(self, input_url, _dataProvider):
        ...
        self.language_translator = Translator(_dataProvider)
